...
/*   Updated: 2025/02/28 16:23:27 by gisrael          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//     while (stack)
//     {
//ft_printf("num: %d, index: %d, cost: %d, above_median: %d, 
//      cheapest: %d, target: %p\n",
//      stack->num, stack->index, stack->cost, stack->above_median, 
//      stack->cheapest, (void*)stack->target);
// 		stack = stack->next;
// 	}
//     ft_printf("\n");
// }